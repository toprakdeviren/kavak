...
/**
 * @file src/unicode_xid.c
 * @brief Unicode XID_Start / XID_Continue tables (UAX #31).
 *
 * GENERATED by scripts/gen_xid_table.py from Unicode 17.0.0.
 * Do not edit by hand; re-run the generator after a Unicode version bump.
 * XID_Start: 145893 codepoints in 691 ranges.
 * XID_Continue: 149221 codepoints in 806 ranges.
 */
...
#define KAVAK_UNICODE_VERSION "17.0.0"
...
static const kavak_xid_range xid_start_ranges[] = {
  ...
  {0x01C80,0x01C8A}, {0x01C90,0x01CBA}, {0x01CBD,0x01CBF}, {0x01CE9,0x01CEC},
  ...
  {0x0A6A0,0x0A6EF}, {0x0A717,0x0A71F}, {0x0A722,0x0A788}, {0x0A78B,0x0A7DC},
  {0x0A7F1,0x0A801}, {0x0A803,0x0A805}, {0x0A807,0x0A80A}, {0x0A80C,0x0A822},
  {0x0A840,0x0A873}, {0x0A882,0x0A8B3}, {0x0A8F2,0x0A8F7}, {0x0A8FB,0x0A8FB},
  {0x0A8FD,0x0A8FE}, {0x0A90A,0x0A925}, {0x0A930,0x0A946}, {0x0A960,0x0A97C},
  {0x0A984,0x0A9B2}, {0x0A9CF,0x0A9CF}, {0x0A9E0,0x0A9E4}, {0x0A9E6,0x0A9EF},
  {0x0A9FA,0x0A9FE}, {0x0AA00,0x0AA28}, {0x0AA40,0x0AA42}, {0x0AA44,0x0AA4B},
  {0x0AA60,0x0AA76}, {0x0AA7A,0x0AA7A}, {0x0AA7E,0x0AAAF}, {0x0AAB1,0x0AAB1},
  {0x0AAB5,0x0AAB6}, {0x0AAB9,0x0AABD}, {0x0AAC0,0x0AAC0}, {0x0AAC2,0x0AAC2},
  {0x0AADB,0x0AADD}, {0x0AAE0,0x0AAEA}, {0x0AAF2,0x0AAF4}, {0x0AB01,0x0AB06},
  {0x0AB09,0x0AB0E}, {0x0AB11,0x0AB16}, {0x0AB20,0x0AB26}, {0x0AB28,0x0AB2E},
  {0x0AB30,0x0AB5A}, {0x0AB5C,0x0AB69}, {0x0AB70,0x0ABE2}, {0x0AC00,0x0D7A3},
  {0x0D7B0,0x0D7C6}, {0x0D7CB,0x0D7FB}, {0x0F900,0x0FA6D}, {0x0FA70,0x0FAD9},
  {0x0FB00,0x0FB06}, {0x0FB13,0x0FB17}, {0x0FB1D,0x0FB1D}, {0x0FB1F,0x0FB28},
  {0x0FB2A,0x0FB36}, {0x0FB38,0x0FB3C}, {0x0FB3E,0x0FB3E}, {0x0FB40,0x0FB41},
  {0x0FB43,0x0FB44}, {0x0FB46,0x0FBB1}, {0x0FBD3,0x0FC5D}, {0x0FC64,0x0FD3D},
  {0x0FD50,0x0FD8F}, {0x0FD92,0x0FDC7}, {0x0FDF0,0x0FDF9}, {0x0FE71,0x0FE71},
  {0x0FE73,0x0FE73}, {0x0FE77,0x0FE77}, {0x0FE79,0x0FE79}, {0x0FE7B,0x0FE7B},
  {0x0FE7D,0x0FE7D}, {0x0FE7F,0x0FEFC}, {0x0FF21,0x0FF3A}, {0x0FF41,0x0FF5A},
  {0x0FF66,0x0FF9D}, {0x0FFA0,0x0FFBE}, {0x0FFC2,0x0FFC7}, {0x0FFCA,0x0FFCF},
...
#define XID_START_RANGES_COUNT (sizeof xid_start_ranges / sizeof xid_start_ranges[0])

static const kavak_xid_range xid_continue_ranges[] = {
  ...
  {0x00800,0x0082D}, {0x00840,0x0085B}, {0x00860,0x0086A}, {0x00870,0x00887},
  {0x00889,0x0088F}, {0x00897,0x008E1}, {0x008E3,0x00963}, {0x00966,0x0096F},
  ...
  {0x00B55,0x00B57}, {0x00B5C,0x00B5D}, {0x00B5F,0x00B63}, {0x00B66,0x00B6F},
  ...
  {0x00C2A,0x00C39}, {0x00C3C,0x00C44}, {0x00C46,0x00C48}, {0x00C4A,0x00C4D},
  {0x00C55,0x00C56}, {0x00C58,0x00C5A}, {0x00C5C,0x00C5D}, {0x00C60,0x00C63},
  {0x00C66,0x00C6F}, {0x00C80,0x00C83}, {0x00C85,0x00C8C}, {0x00C8E,0x00C90},
  {0x00C92,0x00CA8}, {0x00CAA,0x00CB3}, {0x00CB5,0x00CB9}, {0x00CBC,0x00CC4},
  {0x00CC6,0x00CC8}, {0x00CCA,0x00CCD}, {0x00CD5,0x00CD6}, {0x00CDC,0x00CDE},
  {0x00CE0,0x00CE3}, {0x00CE6,0x00CEF}, {0x00CF1,0x00CF3}, {0x00D00,0x00D0C},
  ...
  {0x00D81,0x00D83}, {0x00D85,0x00D96}, {0x00D9A,0x00DB1}, {0x00DB3,0x00DBB},
  ...
  {0x00E84,0x00E84}, {0x00E86,0x00E8A}, {0x00E8C,0x00EA3}, {0x00EA5,0x00EA5},
  {0x00EA7,0x00EBD}, {0x00EC0,0x00EC4}, {0x00EC6,0x00EC6}, {0x00EC8,0x00ECE},
  {0x00ED0,0x00ED9}, {0x00EDC,0x00EDF}, {0x00F00,0x00F00}, {0x00F18,0x00F19},
  {0x00F20,0x00F29}, {0x00F35,0x00F35}, {0x00F37,0x00F37}, {0x00F39,0x00F39},
  {0x00F3E,0x00F47}, {0x00F49,0x00F6C}, {0x00F71,0x00F84}, {0x00F86,0x00F97},
  {0x00F99,0x00FBC}, {0x00FC6,0x00FC6}, {0x01000,0x01049}, {0x01050,0x0109D},
  {0x010A0,0x010C5}, {0x010C7,0x010C7}, {0x010CD,0x010CD}, {0x010D0,0x010FA},
  {0x010FC,0x01248}, {0x0124A,0x0124D}, {0x01250,0x01256}, {0x01258,0x01258},
  {0x0125A,0x0125D}, {0x01260,0x01288}, {0x0128A,0x0128D}, {0x01290,0x012B0},
  {0x012B2,0x012B5}, {0x012B8,0x012BE}, {0x012C0,0x012C0}, {0x012C2,0x012C5},
  {0x012C8,0x012D6}, {0x012D8,0x01310}, {0x01312,0x01315}, {0x01318,0x0135A},
  {0x0135D,0x0135F}, {0x01369,0x01371}, {0x01380,0x0138F}, {0x013A0,0x013F5},
  {0x013F8,0x013FD}, {0x01401,0x0166C}, {0x0166F,0x0167F}, {0x01681,0x0169A},
  {0x016A0,0x016EA}, {0x016EE,0x016F8}, {0x01700,0x01715}, {0x0171F,0x01734},
  ...
  {0x0180B,0x0180D}, {0x0180F,0x01819}, {0x01820,0x01878}, {0x01880,0x018AA},
  ...
  {0x01ABF,0x01ADD}, {0x01AE0,0x01AEB}, {0x01B00,0x01B4C}, {0x01B50,0x01B59},
  {0x01B6B,0x01B73}, {0x01B80,0x01BF3}, {0x01C00,0x01C37}, {0x01C40,0x01C49},
  {0x01C4D,0x01C7D}, {0x01C80,0x01C8A}, {0x01C90,0x01CBA}, {0x01CBD,0x01CBF},
  {0x01CD0,0x01CD2}, {0x01CD4,0x01CFA}, {0x01D00,0x01F15}, {0x01F18,0x01F1D},
  ...
  {0x01FF6,0x01FFC}, {0x0200C,0x0200D}, {0x0203F,0x02040}, {0x02054,0x02054},
  {0x02071,0x02071}, {0x0207F,0x0207F}, {0x02090,0x0209C}, {0x020D0,0x020DC},
  {0x020E1,0x020E1}, {0x020E5,0x020F0}, {0x02102,0x02102}, {0x02107,0x02107},
  {0x0210A,0x02113}, {0x02115,0x02115}, {0x02118,0x0211D}, {0x02124,0x02124},
  {0x02126,0x02126}, {0x02128,0x02128}, {0x0212A,0x02139}, {0x0213C,0x0213F},
  {0x02145,0x02149}, {0x0214E,0x0214E}, {0x02160,0x02188}, {0x02C00,0x02CE4},
  ...
  {0x03041,0x03096}, {0x03099,0x0309A}, {0x0309D,0x0309F}, {0x030A1,0x030FF},
  {0x03105,0x0312F}, {0x03131,0x0318E}, {0x031A0,0x031BF}, {0x031F0,0x031FF},
  {0x03400,0x04DBF}, {0x04E00,0x0A48C}, {0x0A4D0,0x0A4FD}, {0x0A500,0x0A60C},
  {0x0A610,0x0A62B}, {0x0A640,0x0A66F}, {0x0A674,0x0A67D}, {0x0A67F,0x0A6F1},
  {0x0A717,0x0A71F}, {0x0A722,0x0A788}, {0x0A78B,0x0A7DC}, {0x0A7F1,0x0A827},
  {0x0A82C,0x0A82C}, {0x0A840,0x0A873}, {0x0A880,0x0A8C5}, {0x0A8D0,0x0A8D9},
  {0x0A8E0,0x0A8F7}, {0x0A8FB,0x0A8FB}, {0x0A8FD,0x0A92D}, {0x0A930,0x0A953},
  {0x0A960,0x0A97C}, {0x0A980,0x0A9C0}, {0x0A9CF,0x0A9D9}, {0x0A9E0,0x0A9FE},
  {0x0AA00,0x0AA36}, {0x0AA40,0x0AA4D}, {0x0AA50,0x0AA59}, {0x0AA60,0x0AA76},
  {0x0AA7A,0x0AAC2}, {0x0AADB,0x0AADD}, {0x0AAE0,0x0AAEF}, {0x0AAF2,0x0AAF6},
  {0x0AB01,0x0AB06}, {0x0AB09,0x0AB0E}, {0x0AB11,0x0AB16}, {0x0AB20,0x0AB26},
  {0x0AB28,0x0AB2E}, {0x0AB30,0x0AB5A}, {0x0AB5C,0x0AB69}, {0x0AB70,0x0ABEA},
  {0x0ABEC,0x0ABED}, {0x0ABF0,0x0ABF9}, {0x0AC00,0x0D7A3}, {0x0D7B0,0x0D7C6},
  {0x0D7CB,0x0D7FB}, {0x0F900,0x0FA6D}, {0x0FA70,0x0FAD9}, {0x0FB00,0x0FB06},
  {0x0FB13,0x0FB17}, {0x0FB1D,0x0FB28}, {0x0FB2A,0x0FB36}, {0x0FB38,0x0FB3C},
  {0x0FB3E,0x0FB3E}, {0x0FB40,0x0FB41}, {0x0FB43,0x0FB44}, {0x0FB46,0x0FBB1},
  {0x0FBD3,0x0FC5D}, {0x0FC64,0x0FD3D}, {0x0FD50,0x0FD8F}, {0x0FD92,0x0FDC7},
  {0x0FDF0,0x0FDF9}, {0x0FE00,0x0FE0F}, {0x0FE20,0x0FE2F}, {0x0FE33,0x0FE34},
  {0x0FE4D,0x0FE4F}, {0x0FE71,0x0FE71}, {0x0FE73,0x0FE73}, {0x0FE77,0x0FE77},
  {0x0FE79,0x0FE79}, {0x0FE7B,0x0FE7B}, {0x0FE7D,0x0FE7D}, {0x0FE7F,0x0FEFC},
  {0x0FF10,0x0FF19}, {0x0FF21,0x0FF3A}, {0x0FF3F,0x0FF3F}, {0x0FF41,0x0FF5A},
  {0x0FF65,0x0FFBE}, {0x0FFC2,0x0FFC7}, {0x0FFCA,0x0FFCF}, {0x0FFD2,0x0FFD7},
...
#define XID_CONTINUE_RANGES_COUNT (sizeof xid_continue_ranges / sizeof xid_continue_ranges[0])

/* Half-open binary search over sorted, non-overlapping inclusive ranges. */
static bool in_ranges(const kavak_xid_range *r, size_t n, uint32_t cp) {
  size_t lo = 0, hi = n;
  while (lo < hi) {
...
bool kavak_xid_is_start(uint32_t cp) {
  return in_ranges(xid_start_ranges, XID_START_RANGES_COUNT, cp);
}

bool kavak_xid_is_continue(uint32_t cp) {
  return in_ranges(xid_continue_ranges, XID_CONTINUE_RANGES_COUNT, cp);
}
